  ...
  return (
    ...
    <header className='text-white'>
      ...
      <nav className='
        ...
        {/* HAMBURGER BOX */} 
        <div id='hamburger' onClick={()=>setIsNavExpanded(!isNavExpanded)} className='md:hidden absolute top-10 right-6 cursor-pointer'>
          <Hamburger/>
        </div>
       
        {/* MENU BOX */}
        <div className={isNavExpanded ? 
          `absolute top-0 right-0 w-2/3 md:flex md:relative md:w-2/3 md:h-[96px] lg:w-full` :
          `md:flex md:relative md:w-2/3 md:h-[96px] hidden`}>
        <ul className='
          pt-12
          pl-10
          backdrop-blur-xl 

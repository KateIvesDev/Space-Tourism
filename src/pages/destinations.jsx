...
function Destination() {
	...
	let navActive = 'border-b-3 pb-2 border-white text-white lg:text-left tracking-navText uppercase'
  
	let navInactive = 'border-b-3 pb-2 border-white/0 hover:border-white/50 text-light-lavender tracking-navText uppercase'
						...
						<nav className='w-1/2 md:w-1/3 mx-auto lg:mx-0 lg:w-2/3'>
							<div className='cursor-pointer flex flex-row justify-between'>
								<button onClick={handleClick} value='0'
									className={index == '0' ? navActive : navInactive}>Moon</button>
								<button onClick={handleClick} value='1'
									className={index == '1' ? navActive : navInactive}>Mars</button>
								<button onClick={handleClick} value='2'
									className={index == '2' ? navActive : navInactive}>Europa</button>
								<button onClick={handleClick} value='3'
									className={index == '3' ? navActive : navInactive}>Titan</button>
							</div>
						</nav>

	...
	return (
        ...
        '>
            ...
            ' >
              ...
              '/>
						{/* LINE BLOCK */}
						<div className='h-px mx-auto w-[80%] bg-[#383B4B]'></div>
					</div>
            ...
            lg:w-full'>
                ...
                '>
								...
								<button onClick={handleClick} 
									...
									aria-label="First Crew Card">
								</button>
								<button onClick={handleClick} value='1'
									className={index =='1' ? navActive : navInactive}
									aria-label="Second Crew Card">
								</button>
								<button onClick={handleClick} value='2'
									className={index =='2' ? navActive : navInactive}
									aria-label="Third Crew Card"></button>
								<button onClick={handleClick} value='3'
									className={index == '3' ? navActive : navInactive}
									aria-label="Fourth Crew Card"></button>
							</div>
						</nav>

			...
			<div className='mt-36'>
				...
				<section className='
					...
					<nav className='mx-auto lg:w-1/12'>
						<div className='cursor-pointer flex flex-row lg:flex-col justify-evenly gap-4 my-4 lg:items-center'>
							<button onClick={handleClick} value='0' className={index == '0' ? navActive : navInactive}>
								1
							</button>
							<button onClick={handleClick} value='1' className={index == '1' ? navActive : navInactive}>
								2
							</button>
							<button onClick={handleClick} value='2' className={index == '2' ? navActive : navInactive}>
								3
							</button>
						</div>
					</nav>
					...
					<section className='text-center lg:w-5/12 lg:text-left flex flex-col gap-5'>
						<h2 className='text-[14px] md:text-base text-light-lavender uppercase tracking-navText'>The Terminology...</h2>
						<h3 className='text-h3-sm md:text-h3-md lg:text-h3 uppercase font-bellefair'>{tech.name}</h3>
